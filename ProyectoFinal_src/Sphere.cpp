...
// ctor
///////////////////////////////////////////////////////////////////////////////
Sphere::Sphere(std::string img, float radius, int sectors, int stacks, bool smooth) : interleavedStride(32)
{
...
///////////////////////////////////////////////////////////////////////////////
// print vector of vertices
///////////////////////////////////////////////////////////////////////////////
void Sphere::printVertices() const
{
...
void Sphere::send_vectors()
{
    ...
    glBindBuffer(GL_ARRAY_BUFFER, VBOT);
    glBufferData(GL_ARRAY_BUFFER, getTexCoordSize(), getTexCoords(), GL_STATIC_DRAW);
...
void Sphere::translation(glm::vec3 target)
{
    glm::vec3 direction = target - center;
    center += direction;
    for (int i = 0, s = getVertexCount() * 3; i < s; i += 3)
    {
...
void Sphere::rotation(glm::mat3x3 R, glm::vec3 c)
{
    for (int i = 0, s = getVertexCount() * 3; i < s; i += 3)
    {
        glm::vec3 aux(vertices[i], vertices[i + 1], vertices[i + 2]);
    ...
    center = R * (glm::vec3(center.x, center.y, center.z) - c) + c;
    send_vectors();
}
